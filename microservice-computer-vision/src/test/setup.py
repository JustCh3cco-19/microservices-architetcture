...
if __name__ == '__main__':
    setup_dict = {
        'name': 'TriangolazionePrototipo-R2023a',
        'version': '9.14',
        'description': 'A Python interface to TriangolazionePrototipo',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'TriangolazionePrototipo'
        ],
        'package_data': {'TriangolazionePrototipo': ['*.ctf']}
    }
